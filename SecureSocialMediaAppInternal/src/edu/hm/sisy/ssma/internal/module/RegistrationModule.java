 ...
 */
public class RegistrationModule extends BaseAuthenticationModule
{
	 ...
	 */
	public RegistrationModule( IUserDAOLocal userDAOBean )
	{
		super( userDAOBean );
	}
	 ...
	 */
	public String registerUser( RegistrationUser user )
	{
		try
		{
			...
			// Base 32 codiertes 2-Faktor Secret für Nutzer erzeugen
			String totpSecretBase32 = genTotpSecret();
			...
			// TODO Prüfen ob Nutzer bereits vorhanden (Nutzername bereits vergeben)
	 ...
	 *             Algorithmus existiert nicht
	 */
	private static String genTotpSecret() throws NoSuchAlgorithmException
	{
		// Secure Random Instanz erzeugen um Zufallswerte zu erzeugen
		SecureRandom random = SecureRandom.getInstance( RANDOM_GENERATION_ALGORITHM );
		...
		// Secret Key Base32 encodieren
		String encodedKey = CodecUtility.byteToBase32( secretKey );
